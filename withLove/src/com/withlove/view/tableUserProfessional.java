 ...
 * @author SENA
 */
public class tableUserProfessional extends javax.swing.JPanel {
    ...
    public tableUserProfessional(Professional professional) {
        initComponents();
        this.professional = professional;
        loadDataIntoTable();      
       this.txtNameI.setText("Hello "+professional.getNameProfessional()+" "+professional.getLastNamePr());
       this.txtTime.setText("Today is  "+today.getDate()+"/"+(month+1)+"/"+ year);
        
    }
    
    private void loadDataIntoTable() {
        // Suponiendo que tienes una instancia de PatientDAOImpl llamada patientDAOImpl
        List<Appointment> appointments = appointmentDAO.getAllOnePro(professional.getIdProfessional());

        // Preparamos los datos para la tabla
        Object[][] data = new Object[appointments.size()][4]; // 9 es el número de columnas que tienes en tu tabla
        String[] columnNames = {"ID", "ID Professional", "Date","Hour"};
        ...
        for (int i = 0; i < appointments.size(); i++) {
          ...
          Appointment app = appointments.get(i);
            ...
            data[i][2] = app.getDateAvailable();
            data[i][3] = app.getHourAvailable();
